...
def generate_response_rag(user_input):
    ...
    index = PineconeVectorStore(index_name=pinecone_index_name, embeddings=embeddings, namespace = os.environ.get("NAMESPACE"), pinecone_api_key= os.environ.get("PINECONE_API_KEY") )
    ...
    question = f"""  
        ...
        Response: I can assist with you based on the information available in my database.
