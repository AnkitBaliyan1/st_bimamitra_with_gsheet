...
def generate_response_rag(user_input):
    ...
    index = PineconeVectorStore(index_name=pinecone_index_name, embedding=embeddings, namespace = os.environ.get("NAMESPACE"), pinecone_api_key= os.environ.get("PINECONE_API_KEY") )
